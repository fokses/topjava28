...
public class MealService {
    ...
    public Meal create(int userId, Meal m) {
        return repository.save(userId, m);
    }
    ...
    public void update(int userId, Meal m) {
        checkNotFoundWithId(repository.save(userId, m), m.getId());
    }
}